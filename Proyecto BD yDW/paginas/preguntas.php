      ...
      <div class="food_offer3" >
          <div class="overlay">
            <div class="valign_wrapper">
              <h1 class="food_offer_heading " >Preguntas Frecuentes</h1>
              </div>
          </div>
        </div>
      </section>
          ...
          <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <hr>
                    <?php $result = $mysqli->query("SELECT * FROM preguntas") or die($mysqli->error);
                    while ($row = mysqli_fetch_assoc($result)){?>
                    <h3> <?php echo $row['pregunta']?> </h3>
                        <p class="line-space"> <?php echo $row['detalle']?> </p>
                    <br>
                    <?php }?>
                </div>
            </div>
