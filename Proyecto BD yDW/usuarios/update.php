...
require_once '../permisos/permiso.php';
    if(isset($_GET['edit'])){
        $ID_user=$_GET['edit'];
        $result = $mysqli->query("SELECT * FROM usuario WHERE ID_user =$ID_user ")
        or die($mysqli->error);    
    }
...
<section id="n1">
        ...
        <div class="row">
            ...
            <div class="col-4">
                <form action="" method="" class="form-signin" id="form">
                    ...
                    <hr>
                    <input type="hidden" name="ID_user" class="form-control" id="ID_user" value="<?php echo $row['ID_user']; ?>">
                    <label class="">Rol</label>
                    <?php $res = $mysqli->query("SELECT * FROM roles ");
    ...
    <?php 
            ...
            <?php
                    ...
                    if($ID_role!=null){
                        $result = $mysqli->query("UPDATE usuario SET ID_role = '".$ID_role."' 
