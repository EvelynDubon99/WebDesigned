  ...
  <body class="text-center">
    ...
    <div class="container">
            <div class="row">
                ...
                <div class="col-4">
                    <a href="ingreso.php" class="btn btn-lg btn-primary btn-block" id="primary">Agragar</a>
                </div>
            </div>
    </section>
   ...
   <section id="n1">
      ...
      <div class="row">
          ...
          <div class="col-md-12">
          <h3 class="text-center"> Detalle Platillo </h3>
          <div class=" table-responsive-md">
            ...
            <tbody>
              <?php
                ...
                if(isset($_GET['add'])){
                    $ID_platillo=$_GET['add'];
                    $result = $mysqli->query("SELECT * FROM detalle_platillo where ID_platillo = $ID_platillo ")
                    or die($mysqli->error);    
                }
              ...
              <tr>
                ...
                <td>
                <a href="tabla.php " class="badge badge-primary"> Ingredientes</a>
                <a href="delet2.php?delete=<?php echo $row['ID_platillo']?>" class="badge badge-danger">Delete</a>
                <a href="platillos.php" class="badge badge-success">Regresar</a>
                </td>
              </tr>
                <?php }?>
            </tbody>
