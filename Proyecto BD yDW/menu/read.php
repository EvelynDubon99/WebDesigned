...
require_once '../permisos/permiso.php';
    if(isset($_GET['read'])){
        $ID_menu=$_GET['read'];
        $result = $mysqli->query("SELECT m.ID_menu, m.ID_platillo, p.nombre, m.Tiempo_comida FROM menu m inner join platillo p
         on m.ID_platillo = p.ID_platillo WHERE ID_menu =$ID_menu ")
        or die($mysqli->error);    
    }
              ...
              <nav>
                <div class ="container-fluid">
                  <div class="row justify-content-center">
                    <div class= "col-md-10">
                      <h3 class="text-center mt-2"> Datos menu </h3>
                      <hr>
                    </div>
                  </div>
                </div>
...
<section id="n1">
    ...
    <div class="container">
        ...
        <div class="col-12">
            ...
            <a href="catalogo.php " class="btn btn-info" id="primary">Regresar</a>
    <?php }?>
